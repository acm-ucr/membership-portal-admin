...
const Resource = ({ ops, resource, setVisible }) => {
  ...
  return (
    <div className="fixed inset-0 bg-opacity-98 backdrop-blur-sm flex justify-center items-center">
      <div className="w-1/2 bg-acm-lightgray p-2 rounded-2xl">
        ...
        {operation === "add" && (
          <button
            ...
            className="bg-acm-black text-acm-white px-4 py-2 my-2 rounded-full font-lexend"
          >
            add
          </button>
        )}
